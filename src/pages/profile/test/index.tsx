...
const OtherPersonProfile = () => {
    ...
    const profileUrl = `${apiUrl}portal/user-profile/${id}`;
    ...
    const { data: profileData } = useGetPorfileQuery(id)
    const { data: socialLinkData } = useGetAllSocialLinksQuery({});


    const { artifactUrl = AvatarImg, firstName, lastName, city, nationality, profileRating } = profileData?.data || {}
